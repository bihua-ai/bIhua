...
class ConfigLoader:
    def __init__(self, config_dir, env_file_name=".env", log_config_file_name="log.conf"):
        """
...
def initialize_config_manager(config_dir, env_file_name=".env", log_config_file_name="log.conf"):
