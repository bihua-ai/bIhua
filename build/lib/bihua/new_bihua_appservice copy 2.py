...
class BihuaAppservice:
    ...
    def register_agent(homeserver_url, appservice_token, homeserver_token):
    ...
    # # Example usage
    # homeserver_url = "http://localhost:8008"  # Synapse homeserver URL
    # appservice_token = "bihua_agent_appservice_token"
    # homeserver_token = "bihua_agent_homeserver_token"

    # result = register_appservice(homeserver_url, appservice_token, homeserver_token)
    # if result:
    #     print("Response from Synapse:", result)
